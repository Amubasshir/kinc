  ...
  return (
    <section className="gift-card" aria-labelledby="gift-card-heading">
      <div className="gift-card-content">
        ...
        <p>
          Perfect for milestone birthdays, Mother&apos;s Day, or a unique baby shower gift.<br />
          The KinCollage digital voucher allows the recipient to curate their favourite<br />
        ...
        <form className="gift-card-form">
          ...
          <input id="voucher-amount" name="amount" type="number" min="1" step="1" inputMode="decimal" placeholder="$ [ Enter Amount ] AUD" required />
