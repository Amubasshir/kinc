...
export default function ArtistTestimonial({ testimonial }: { testimonial: ArtistViewModel["testimonial"] }) {
  ...
  return (
    <section className="artist-testimonial" aria-label={"Testimonial from " + testimonial.name}>
      <Image
        className="artist-testimonial-background"
      ...
      <div className="artist-testimonial-stack">
        <Image
          className="artist-testimonial-shadow"
        ...
        <div className="artist-testimonial-card">
          <Image
            className="artist-testimonial-card-background"
          ...
          />
          <Image
            className="artist-testimonial-quote-mark"
          ...
          />
          <blockquote>
            <div className="artist-testimonial-stars" aria-label={testimonial.rating + " out of 5 stars"}>
