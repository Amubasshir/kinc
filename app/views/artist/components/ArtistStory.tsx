...
export default function ArtistStory({
  ...
  if (videoOnly) {
    return (
      <section
        className="commission-story-video rounded-t-none rounded-b-[20px] bg-[url('/contact-background.png')] bg-cover bg-center px-6 py-[92px] max-[700px]:rounded-t-none max-[700px]:rounded-b-[18px] max-[700px]:px-3 max-[700px]:py-10"
  ...
  return (
    <section
      className="artist-story min-h-[977px] overflow-hidden rounded-[20px] bg-[#00d18f] px-6 pt-[72px] pb-[79px] text-center text-[#2E2E38] max-[800px]:min-h-0 max-[800px]:rounded-[20px] max-[800px]:px-5 max-[800px]:pt-16 max-[800px]:pb-[76px] max-[700px]:flex max-[700px]:flex-col max-[700px]:px-[14px] max-[700px]:pt-1 max-[700px]:pb-[31px]"
      aria-labelledby="artist-story-heading"
    >
      <h2
        className="text-[48px] leading-[1.12] tracking-[.2px] max-[800px]:text-[clamp(38px,11vw,46px)] max-[700px]:order-1 max-[700px]:mt-[17px] max-[700px]:text-[31px]"
        id="artist-story-heading"
      >
        Watch our Story
      </h2>
      <div className="artist-story-copy mt-5 max-[700px]:order-2 max-[700px]:mt-[14px] [&>p]:text-[16px] [&>p]:leading-[1.6] [&>p+p]:mt-5 max-[800px]:[&>p]:text-[14px] max-[800px]:[&>p]:leading-[1.6] max-[700px]:[&>p]:text-[14px] max-[700px]:[&>p]:leading-[1.6]">
        ...
        <p className="!text-[16px]">
          In this short video, <span className="font-semibold">I take you </span>{" "}
          <mark>
            {" "}
