...
export default function Faqs({ faqs }: { faqs: FaqModel[] }) {
  return (
    <section id="faqs" className="faqs min-h-[790px] rounded-[20px] bg-white px-6 pt-[91px] pb-[70px] text-[#555] max-[700px]:min-h-0 max-[700px]:rounded-[18px] max-[700px]:px-[22px] max-[700px]:pt-[45px] max-[700px]:pb-[31px]" aria-labelledby="faqs-heading">
