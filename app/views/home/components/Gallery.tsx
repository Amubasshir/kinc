...
export default function Gallery({ columns }: { columns: number[][] }) {
  return (
    <section id="gallery" className="gallery-section relative min-h-[1030px] overflow-hidden rounded-[20px] px-6 pt-11 pb-[70px] max-[700px]:min-h-0 max-[700px]:rounded-none max-[700px]:px-1 max-[700px]:pt-[34px] max-[700px]:pb-[38px]" aria-label="KinCollage gallery">
