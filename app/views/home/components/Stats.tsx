...
export default function Stats({ stats }: { stats: StatModel[] }) {
  ...
  return (
    <section ref={sectionRef} className="stats min-h-[534px] rounded-[20px] px-6 pt-[111px] pb-20 text-[#263443] max-[700px]:rounded-[20px] max-[700px]:px-6 max-[700px]:pt-[43px] max-[700px]:pb-[54px]" aria-label="KinCollage statistics">
