...
export default function About() {
  return (
    <section className="about flex min-h-[520px] items-center justify-center gap-20 rounded-[20px] bg-[#00d18f] px-10 py-[70px] text-[#2E2E38] max-[1100px]:flex-col max-[1100px]:gap-10 max-[1100px]:text-center max-[700px]:min-h-0 max-[700px]:rounded-[18px] max-[700px]:px-4 max-[700px]:pt-5 max-[700px]:pb-7 max-[700px]:gap-[29px]" aria-labelledby="about-heading">
