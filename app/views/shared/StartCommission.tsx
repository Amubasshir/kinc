...
export default function StartCommission({ compact = false }: { compact?: boolean }) {
  ...
  return (
      ...
      <p className="mt-[19px] text-[16px] leading-[1.6] max-[700px]:max-w-[520px] max-[700px]:text-[14px] max-[700px]:leading-[1.6]">
        {compact ? (
          <>
            Create a beautiful statement piece
            <br />
            for your home, or a deeply
            <br />
            meaningful keepsake for
            <br />
            grandparents.
          </>
        ) : (
          "Create a beautiful statement piece for your home, or a deeply meaningful keepsake for grandparents."
        )}
      </p>
