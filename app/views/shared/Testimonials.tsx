    ...
    <article className="testimonial-card overflow-hidden rounded-[20px] bg-white shadow-[0_0_0_1px_rgb(46_46_56/4%)] max-[800px]:rounded-[20px] max-[700px]:w-full max-[700px]:rounded-[20px]">
      ...
      <div className="testimonial-copy px-9 pt-[31px] pb-[25px] max-[1200px]:px-[25px] max-[800px]:px-[26px] max-[800px]:pt-[27px] max-[800px]:pb-[30px] max-[700px]:px-[23px] max-[700px]:pt-[29px] max-[700px]:pb-8 [overflow-wrap:anywhere]">
        ...
        <footer className="mt-[22px]">
          ...
          <p className="mt-2 text-[14px] leading-[1.2] text-[#515151]">{testimonial.location}</p>
        </footer>
      </div>
    </article>
  );
...
export default function Testimonials({ testimonials }: { testimonials: TestimonialModel[] }) {
  ...
  return (
    <section id="testimonials" className="testimonials rounded-[20px] bg-transparent px-6 pt-[95px] pb-[33px] text-[#5b5b5d] max-[800px]:rounded-2xl max-[800px]:px-[22px] max-[800px]:pt-[70px] max-[800px]:pb-[38px] max-[700px]:rounded-none max-[700px]:px-0 max-[700px]:pt-[30px] max-[700px]:pb-[22px]" aria-labelledby="testimonials-heading">
      <h2 className="text-center text-[48px] leading-[1.15] font-light tracking-[.2px] max-[800px]:text-[42px] max-[700px]:px-[23px] max-[700px]:text-left max-[700px]:font-[var(--font-tenor-sans)] max-[700px]:text-[31px]" id="testimonials-heading">Testimonials</h2>
      <p className="testimonials-intro mx-[23px] mt-[22px] hidden text-[14px] leading-[1.6] text-[#777] max-[700px]:block [overflow-wrap:anywhere]">Share the magic with family. Print your child&apos;s custom collage onto a limited collection of premium everyday objects, creating an unforgettable keepsake for grandparents and loved ones.</p>
