    ...
    <>
      ...
      {viewModel.sections.map((section) => (
        ...
        >
          ...
          <div className="legal-copy mx-auto mt-[62px] max-w-[1050px] font-[var(--font-montserrat)] text-[16px] leading-[1.5] max-[700px]:mt-10 max-[700px]:text-[16px] max-[700px]:leading-[1.5]">
